...
import work.gaigeshen.springcloud.demo.commons.web.HttpStatusErrorResultCode;
...
public class JWTTokenFilter implements GlobalFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (Objects.isNull(authorization)) {
            return renderResult(response, Results.create(HttpStatusErrorResultCode.UNAUTHORIZED));
        }
        ...
        try {
            ...
            return renderResult(response, Results.create(HttpStatusErrorResultCode.FORBIDDEN));
        }
